...
Public Class MainForm
    ...
    Private Sub MyMainForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        output_txt.AppendText("INFO: Mini Web Server BETA v" & My.Settings.version)
    ...
    Private Sub Start_Click(sender As Object, e As EventArgs) Handles start_btn.Click
    ...
    Private Sub Restart_Click(sender As Object, e As EventArgs) Handles restart_btn.Click
    ...
    Private Sub Stop_Click(sender As Object, e As EventArgs) Handles stop_btn.Click
